(define (domain FOND_full_complete_5_4)
    ...
    (:action Move-to-target-fully-loaded
        :precondition (and (not (at-target)) (not (zero carrying)) (zero free-grippers))
        :effect (and (at-target))
    )
    (:action Move-to-target-half-loaded
        :precondition (and (not (at-target)) (not (zero carrying)) (not (zero free-grippers)) (zero balls-at-source))
        :effect (and (at-target))
    )
    (:action Pick-ball_f0_d1
    ...
    (:action Leave
        :precondition (and (at-target) (zero carrying) (not (zero free-grippers)))
